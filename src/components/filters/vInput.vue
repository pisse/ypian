<template>
  <div class="search-bar constant-cpt">
    ...
    <div class="input-wrap">{{opt.value}}
      <v-input size="small" @focus="onFocus" @blur="onBlur" v-model="formData[opt['key']]"  :on-icon-click="handleIconClick" :icon="opt.icon" :placeholder="opt.placeHolder ? opt.placeHolder : '请输入内容'"></v-input>
    </div>
